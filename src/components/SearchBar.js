          ...
          <div className="card mt-3">
            <div>
              <li key={material.id} className="list-group-item">
                ...
                <p className="card-text"><strong>Descripción: </strong>{material.description}</p>
              ...
              <>
                ...
                <p className="card-text"> <strong>Tipo:</strong> {material.type}</p>
                <p className="card-text"> <strong>Medio de Contacto: </strong> {material.contacto}</p>
            </li> 
            </div>  
          </div>  
        ))} 
